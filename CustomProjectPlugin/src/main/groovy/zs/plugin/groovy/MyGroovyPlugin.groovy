...
class MyGroovyPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        project.task('AGroovyTask') {
            ...
            doFirst {
                System.out.println("I'm from the zs.plugin.groovy.MyGroovyPlugin.AGroovyTask.doFirst")
            }
            doLast {
                System.out.println("I'm from the zs.plugin.groovy.MyGroovyPlugin.AGroovyTask.doLast")
            }
        }
