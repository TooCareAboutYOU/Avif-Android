 ...
 */
abstract class WorkCreateMD5Task3 extends SourceTask {
    ...
    @TaskAction
    void createHashes() {
        WorkQueue workQueue = getWorkerExecutor().processIsolation(new Action<ClassLoaderWorkerSpec>() {
            @Override
